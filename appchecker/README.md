...
La referencia visual original está en [`design/dashboard-concept.png`](design/dashboard-concept.png). La captura en [`design/dashboard-implementation.jpg`](design/dashboard-implementation.jpg) corresponde a la base anterior al cambio de marca y se conserva solo como comparación histórica.
